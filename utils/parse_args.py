...
def parse_args():
    ...
    parser.add_argument("--checkpoint_dir", type=str, default="/scr/anon/ckpt", help="Checkpoint Directory")
    parser.add_argument("--results_dir", type=str, default="/scr/anon/ckpt", help="Log Directory")
