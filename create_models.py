...
if __name__ == "__main__":
    act_hist_path = f"/scr/anon/exps/pre_finetune/Mistral_Sparse/refined_web_act_hist.pt"
    ...
    relu_path = "/scr/anon/exps/relu_mistral"
    sparse_path = "/scr/anon/exps/sparse_mistral"
